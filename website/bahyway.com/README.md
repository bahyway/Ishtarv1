...
1. **"No third-party dependencies"** — restated as "a deliberately minimal
   ...
   Same fix as beemdm.com and docs/00_codex/WHAT_IS_BAHYWAY.md — false on its face
...
2. **The EnkiDB port table was factually wrong**, not just simplified. The
   ...
   verified mapping (`docs/05_storage/ENKIDB_7_TYPES.md`) is EnkiDB:7001
...
3. **"ENLIL ring"** — ENLIL already names the ecosystem's Total Algebra
   ...
   index stack itself was deliberately renamed to the **Anu Index Stack** (2026-07-13), and renamed again to the **Elu Index Stack** (2026-08-15) when "Anu" was reclaimed for AnuGovernor.
...
5. **DubSar Theater tile described the aspirational egui/WGPU rewrite**
   ...
   (PB-262). Same fix as `docs/00_codex/WHAT_IS_BAHYWAY.md`. Updated the tile's
...
(no-third-party-dependencies, ENLIL vs the Elu Index Stack, and the
...
top-level `docs/00_codex/WHAT_IS_BAHYWAY.md` and in beemdm.com's docs page — all
