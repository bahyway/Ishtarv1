...
`docs/components/HEPTASCRIPT_QUERY_LANGUAGE.md` (the Manual) — that
...
## Foundational (shared across the Ecosystem — brief; full definitions in `docs/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md`)
