...
**Landing note (2026-08-21):** landed from the Mon20260817 delivery; citations of GL-ONT-002 updated to GL-ONT-003 (see `docs/01_mathematics/GL-ONT-003-non-substitution-law.md` for why). Per the reconciliation already recorded across this repo's Way of Work docs, the "KVM VMs" leg of the pipeline above is historical: `eriduous-vdi` is retired as of v4.0 and Ansible now runs from the Fedora bare-metal host directly against `uruk` (see `ansible/inventory.ini`). See `docs/mon20260817-incoming/README.md` for the original, unmodified draft.
...
### 1.1 The Non-Substitution Law (GL-ONT-003)
...
| Ontology | GL-ONT-003, the founding law |
...
As of this landing: tablets=8       playbooks=386       tree_sha=1906a860.
<!-- END PB-686 WED0826 LANDINGS -->
## Appendix — Foundational Documents

- **GL-ONT-003** — The Non-Substitution Law (the foundation)
