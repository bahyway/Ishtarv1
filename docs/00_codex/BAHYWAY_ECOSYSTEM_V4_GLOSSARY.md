...
`docs/08_pipeline_alaktu/TRANSPARENCY_STANDARD.md` — ✅ VERIFIED, 🧩 PARTIAL, 📄 DOCUMENTED,
...
`docs/13_changelog/RM-001_ADDENDUM_PB111-145_VERIFIED_2026-07-01.md`). **🧩 PARTIAL**
...
`docs/15_howto/BAHYWAY_V4_ARCHITECTURE_REFERENCE_2026-07-11.md` §3 for the full,
...
`docs/15_howto/BAHYWAY_V4_ARCHITECTURE_REFERENCE_2026-07-11.md` §4 for the
...
`docs/15_howto/BAHYWAY_V4_ARCHITECTURE_REFERENCE_2026-07-11.md` §2 for full
