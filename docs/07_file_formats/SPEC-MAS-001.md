...
- `Prover` is now a real trait with two methods, both invoked by
  ...
  - `residual_trustworthy` — gates DETECT. Defaults to `true`: no
    ...
    ecosystem yet (`docs/07_file_formats/GL-EGD-001.md` already names this as a
...
NL-001's existing convention (see `docs/01_mathematics/SPEC-FDD-001.md` §Naming)
...
- `docs/01_mathematics/PH-002_Puhu_Law.md` — the TOP Algebra law this pattern's
