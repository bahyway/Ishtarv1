...
**This document follows `docs/08_pipeline_alaktu/TRANSPARENCY_STANDARD.md` (sealed
...
`docs/00_codex/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md` (see that document's H and K
...
**Correction made in this pass:** `docs/00_codex/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md`'s
...
| CSR-06 | KIBRATU Emission | connection error paths | ✓ real, coded (stub emission). The emission step is real; the specific `KibratuCause` 7-variant taxonomy some documents attach to it is not — see `docs/00_codex/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md` §K, corrected 2026-07-11. |
...
| Doc ID | Title | File |
|---|---|---|
| GL-ADU-002 | Addu Cyclone Extension Law | `docs/01_mathematics/GL-ADU-002-cyclone-extension.md` |
| GL-MRD-002 | Nēberu Slicer — Orbit Section & 7D Wave Law | `docs/01_mathematics/GL-MRD-002-neberu-slicer.md` |
| GL-MRD-002 Rev.2 | Analysis-to-Solution Law (DETECT→PROVE→PREDICT→PRESCRIBE) | same file, §7 |
| GL-DST-001 | Theater-as-Workbench Law | `docs/09_observatory/GL-DST-001-theater-as-workbench.md` |
...
in `docs/99_index/CAT-001-index.md`.
...
`docs/17_troubleshooting/TESTING_PLAYBOOK_PHASE1.md` is the real, existing, run-in-order
