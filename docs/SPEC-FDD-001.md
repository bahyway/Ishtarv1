...
- It cited "BC-ENV-001 Rev. 2" as sealing WPDEngine's use of the
  ...
  of these exist: `docs/BC-ENV-001_Enbilulu_Calculus_2026-07-07.md` has
...
- It proposed **"Nergal"** as a naming candidate for the new domain's
  ...
  already caught once before, while drafting `docs/SPEC-MAS-001.md`'s
...
- It named "PB-160, Phase 2, BeeMDM's 50-zip proof" as the completion
  ...
  test, per `docs/RM-002_ADDENDUM_VERIFIED_2026-07-07.md` and
  `docs/BC-ENV-001_Enbilulu_Calculus_2026-07-07.md`'s identical
  "Governing law" line — is confirmed **not yet closed**: PB-99, the
  Phase B / `TESTING_PLAYBOOK_PHASE1` gate itself, is still status
  `[ ]` (not run) in `docs/PLAYBOOK_EXECUTION_TRIAGE.md` as of this
...
- The oil/gas calculus is **Ishum**, not a name proposed fresh here:
  `docs/SPEC-MAS-001.md`'s own Naming section (amendment A2) already
