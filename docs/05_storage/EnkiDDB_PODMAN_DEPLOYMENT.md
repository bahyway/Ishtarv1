...
- The current `master`-promoted commit (see `docs/08_pipeline_alaktu/OTAP_PIPELINE.md`) present
...
- **ENLIL 7-index stack / HeptaScript v2.0 unification**: not part of this
  ...
  specifics (see `docs/08_pipeline_alaktu/OTAP_PIPELINE.md`'s "definition of done").
