# UrOS — Runtime, Scheduler, Supervisor (§11)
...
"UrOS" names the three crates that give BahyWay.Ecosystem v4.0 its
...
(`docs/15_howto/BAHYWAY_V4_ARCHITECTURE_REFERENCE_2026-07-11.md` §8.1) — not a
...
`enkisdb-write-server` (see `docs/17_troubleshooting/PB-221_SCALE_BENCHMARK_FINDINGS.md`
