...
- CSR-08 "Architect Sovereignty" — same wording as the NINSUN glossary doc (item 4 below). **Added to `docs/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md` CSR table this session** (was missing; table only had CSR-01–07).
...
1. `docs/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md` — added CSR-08 to the CSR table (was silently missing; table said "7 rules" and stopped at CSR-07).
