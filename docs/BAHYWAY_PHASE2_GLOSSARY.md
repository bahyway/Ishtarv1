...
resolved, cross-checked against `docs/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md`
...
SEALED-CONCEPT — see `docs/catalog/CAT-001-index.md` for per-doc status.
...
- **Hala 𒄩𒆷** — sovereign rename of **Uruinimgina**, the docs Reform & Pulse
  ...
  - Per the Concordance Doctrine (`docs/law_lattice_7x7_tablets.md`,
...
- **Flight-to-Location** — the Nabû→NaviEngine→Hubble three-engine pipeline.
  Sealed as **`GL-NAV-001`** (`docs/GL-NAV-001-flight-to-location.md`) —
...
- **GL-DOC-001** (Single Glossary Law, FOUNDATIONAL-DOC) — one glossary
  ...
  `docs/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md` are both real, separate
  ...
  - **Correction, 2026-08-15**: all five of the above existed ONLY as
    ...
    sibling reasoning and `docs/catalog/CAT-001-index.md`.
