...
A cross-domain pattern like Massartu (`docs/SPEC-MAS-001.md`) is only
...
what the Massartu spec (`docs/SPEC-MAS-001.md`) calls "correct by
...
(`docs/BATCH5_RM001_RM002_PBCOLLECTIONS_PH001_VERIFIED_2026-07-07.md`,
...
- No King-plot-style residual classifier exists anywhere in this
  ecosystem (`docs/GL-EGD-001.md`); `Prover::residual_trustworthy`
...
- `docs/SPEC-MAS-001.md` — the Massartu pattern's own boundary spec,
