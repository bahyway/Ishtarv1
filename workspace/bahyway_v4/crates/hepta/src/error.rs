...
impl core::fmt::Display for HeptaError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            HeptaError::UnknownCoordSystem(s) =>
                write!(f, "unknown coordinate system: '{}'", s),
            ...
            HeptaError::MaxZoomReached =>
                write!(f, "maximum Hobble-Zoom depth reached (2 levels)"),
            ...
            HeptaError::DensityOutOfRange(v) =>
                write!(f, "density {} out of range 0\u{2013}63", v),
            HeptaError::MalformedHex(s) =>
                write!(f, "malformed hex literal: '{}'", s),
            HeptaError::MissingDirective(d) =>
                write!(f, "missing required directive: {}", d),
            HeptaError::DuplicateLabel(s) =>
                write!(f, "duplicate block label: '{}'", s),
            HeptaError::InvalidNodeRef(s) =>
                write!(f, "invalid node ref: '{}'", s),
        }
    }
}
