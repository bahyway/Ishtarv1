...
//! (`shakkanakku::pb_catalog`). Drives it from a TOML config and a
//! terminal, no windowing session required — same rationale as
//! `uruinimgina-cli` (Hala's headless face, as of Phase 2
//! reconciliation -- see docs/BAHYWAY_PHASE2_GLOSSARY.md). Built for PB-289
...
use shakkanakku::pb_catalog::{catalog_playbooks, CatalogLocation};
