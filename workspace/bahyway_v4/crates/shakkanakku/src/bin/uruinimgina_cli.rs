...
//! (`shakkanakku::docpulse`). Same engine the Uruinimgina tab in the native
//! `shakkanakku` app drives (feature "gui") -- this binary drives it from
...
use shakkanakku::docpulse::{spawn_docpulse, DocPulseCfg};
use shakkanakku::model::{Ctl, RunnerEvent};
use std::io::BufRead;
