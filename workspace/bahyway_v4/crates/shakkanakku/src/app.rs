//! The governor's face — egui implementation of the Shakkanakku blueprint.
...
/// -- see docs/BAHYWAY_PHASE2_GLOSSARY.md "Hala" entry for why the binary
...
impl eframe::App for ShakkanakkuApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::TopBottomPanel::top("title").exact_height(32.0).show(ctx, |ui| {
            ...
            let bar_resp = ui.interact(bar_rect, egui::Id::new("shakkanakku_titlebar_drag"), egui::Sense::click_and_drag());
            ...
            ui.horizontal(|ui| {
                ui.label(RichText::new("𒑐 Shakkanakku").size(19.0).color(WAX));
                ui.add_space(10.0);
        ...
        egui::SidePanel::right("remedy").min_width(300.0).show(ctx, |ui| {
            ...
            match remedy_rule {
                ...
                None => {
                    ...
                    ui.label(RichText::new("Solve it once — then add a [[remedy]] rule so Shakkanakku remembers forever.")
                        .color(DIM).small());
                }
            }
            ui.separator();
