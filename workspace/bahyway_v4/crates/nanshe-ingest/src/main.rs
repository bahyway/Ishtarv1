//! nanshe-ingest — CLI runner
//! Usage: nanshe-ingest <path/to/archive>
//!
//! Reads file bytes from disk, calls ingest(), prints summary.
#![forbid(unsafe_code)]
...
fn main() {
    ...
    let report = nanshe_ingest::ingest(&bytes, filename);
    println!("nanshe-ingest complete");
    ...
    nanshe_ingest::hand_to_mashsharu(&report);
