...
pub fn draw(ui: &mut egui::Ui, engine: &mut ChatEngine) {
    ui.vertical(|ui| {
        ui.horizontal(|ui| {
            ui.label(RichText::new("𒀭 TamuzAI").size(18.0).color(Color32::from_rgb(255, 215, 0)));
            ui.separator();
            ...
            .show(ui, |ui| {
                for msg in &engine.panel.messages {
                    let (label_color, bg_color) = match msg.kind {
                        MessageKind::User      => (Color32::from_rgb(100,180,255), Color32::from_rgb(20,30,45)),
                        MessageKind::Assistant => (Color32::from_rgb(255,215,0),   Color32::from_rgb(30,25,10)),
                        MessageKind::Command   => (Color32::from_rgb(0,255,136),   Color32::from_rgb(10,30,20)),
                        MessageKind::Error     => (Color32::from_rgb(255,80,80),   Color32::from_rgb(40,10,10)),
