...
pub fn apply(ctx: &egui::Context) {
    ...
    vis.widgets.noninteractive.fg_stroke = egui::Stroke::new(1.0_f32, AXIS_LINE);
    vis.widgets.noninteractive.bg_stroke = egui::Stroke::new(1.0_f32, RING_LINE);
    vis.widgets.noninteractive.rounding = Rounding::same(4.0);

    vis.widgets.inactive.bg_fill = BG_CARD;
    vis.widgets.inactive.fg_stroke = egui::Stroke::new(1.0_f32, TEXT_DIM);
    vis.widgets.inactive.bg_stroke = egui::Stroke::new(1.0_f32, Color32::from_rgb(35, 35, 60));
    vis.widgets.inactive.rounding = Rounding::same(4.0);

    vis.widgets.hovered.bg_fill = BG_HOVER;
    vis.widgets.hovered.fg_stroke = egui::Stroke::new(1.5_f32, GOLD);
    vis.widgets.hovered.bg_stroke = egui::Stroke::new(1.0_f32, GOLD.linear_multiply(0.5));
    vis.widgets.hovered.rounding = Rounding::same(4.0);

    vis.widgets.active.bg_fill = BG_HOVER;
    vis.widgets.active.fg_stroke = egui::Stroke::new(2.0_f32, GOLD);
    vis.widgets.active.bg_stroke = egui::Stroke::new(1.5_f32, GOLD);
    vis.widgets.active.rounding = Rounding::same(4.0);

    vis.widgets.open.bg_fill = BG_HOVER;
    vis.widgets.open.fg_stroke = egui::Stroke::new(1.5_f32, CYAN);
...
pub fn card_frame(fill: Color32) -> egui::Frame {
    egui::Frame::none()
        ...
        .stroke(egui::Stroke::new(1.0_f32, Color32::from_rgb(30, 30, 60)))
}
