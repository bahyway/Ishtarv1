...
pub static ALIGNMENTS: &[BahywayAlignment] = &[
    ...
    BahywayAlignment {
        ...
        mapping_note:
            "Orchestrates quality triage, promotion/demotion decisions, and remediation workflows.",
    },
    BahywayAlignment {
    ...
    BahywayAlignment {
        ...
        mapping_note:
            "COMMIT_MARKER=0xCA seals each write batch; replay reconstructs the audit trail.",
    },
    BahywayAlignment {
        ...
        mapping_note:
            "Validates every particle against tribal sovereignty rules before acceptance.",
    },
    // ── Metadata ──────────────────────────────────────────────────────────────
    BahywayAlignment {
    ...
    BahywayAlignment {
        ...
        mapping_note:
            "This crate IS the sovereign data dictionary — 100+ DAMA terms with definitions.",
    },
    ...
    BahywayAlignment {
        ...
        mapping_note:
            "Core append-only event log; single source of truth for all particle history.",
    },
    BahywayAlignment {
        dama_code: "DSO.FSYNC",
        bahyway_crate: "enkidb-storage",
    ...
    BahywayAlignment {
        ...
        mapping_note:
            "On startup, journal entries are replayed to reconstruct in-memory particle state.",
    },
    // ── Data Integration ──────────────────────────────────────────────────────
    BahywayAlignment {
        dama_code: "DI.ETL",
...
pub fn alignments_for(dama_code: &str) -> Vec<&'static BahywayAlignment> {
    ALIGNMENTS
        .iter()
        .filter(|a| a.dama_code == dama_code)
        .collect()
}
...
pub fn alignments_by_crate(crate_name: &str) -> Vec<&'static BahywayAlignment> {
    ALIGNMENTS
        .iter()
        .filter(|a| a.bahyway_crate == crate_name)
        .collect()
}
