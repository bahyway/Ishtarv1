...
//! "Glossary" panel (see docs/07_file_formats/SPEC-MAS-001.md-style honest-scope
...
pub fn seed() -> Registry {
    ...
    Registry(vec![
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/01_mathematics/SPEC-FDD-001.md"),
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/01_mathematics/GL-MRD-002-neberu-slicer.md"),
        ...
        NamingEntry {
            ...
            status: Reserved,
            source_doc: Some("docs/07_file_formats/SPEC-MAS-001.md"),
            crate_path: None,
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/01_mathematics/PH-002_Puhu_Law.md"),
        ...
        NamingEntry {
            ...
            source_doc: Some("docs/01_mathematics/SPEC-FDD-001.md (naming-collision note only)"),
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/13_changelog/BC-ENV-001_Enbilulu_Calculus_2026-07-07.md"),
            crate_path: Some("crates/bahyway-algebra/src/enbilulu.rs"),
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/05_storage/ELU_INDEX_STACK.md"),
            crate_path: Some("crates/elu-tribe-hotindex/src/lib.rs"),
            blurb: "Elû, Akkadian 'high, upper, superior.' Names the index stack (renamed from an earlier 'ENLIL' proposal, then from 'Anu' when the Architect reclaimed that name for AnuGovernor, 2026-08-15) and the Elu Tribe HotIndex crate.",
            image_path: None,
            image_credit: None,
        },
        NamingEntry {
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/00_codex/BAHYWAY_ECOSYSTEM_V4_GLOSSARY.md"),
            crate_path: None,
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/09_observatory/HEPTASCRIPT_GLOSSARY.md"),
        ...
        NamingEntry {
            ...
            status: SealedByLaw,
            source_doc: Some("docs/02_identity/KAKI_V4.md"),
