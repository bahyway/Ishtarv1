//! esarhaddon-ingest — CLI runner
//! Usage: esarhaddon-ingest <path/to/archive>
#![forbid(unsafe_code)]
...
fn main() {
    ...
    let report = esarhaddon_ingest::ingest(&bytes, filename);
    println!("esarhaddon-ingest complete");
    ...
    esarhaddon_ingest::hand_to_mashsharu(&report);
