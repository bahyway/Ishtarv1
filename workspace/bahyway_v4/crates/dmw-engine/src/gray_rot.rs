...
impl GrayRotReport {
    ...
    pub fn from_fragmentation_map(map: &crate::fragmentation::FragmentationMap) -> Self {
        let worst_pct = map.worst_fragment()
            .map(|f| f.fragmentation_pct)
            .unwrap_or(0.0);
        let page_count = map.worst_fragment()
...
mod tests {
    ...
    fn level_boundaries() {
        ...
        assert_eq!(GrayRotLevel::from_fragmentation(10.0), GrayRotLevel::Warning);
        assert_eq!(GrayRotLevel::from_fragmentation(19.9), GrayRotLevel::Warning);
        assert_eq!(GrayRotLevel::from_fragmentation(20.0), GrayRotLevel::GrayRot);
        assert_eq!(GrayRotLevel::from_fragmentation(39.9), GrayRotLevel::GrayRot);
        assert_eq!(GrayRotLevel::from_fragmentation(40.0), GrayRotLevel::Critical);
    }
    ...
    fn narrative_mentions_fragmentation_pct() {
        ...
        assert!(r.narrative().contains("35.0"), "narrative={}", r.narrative());
    }
    ...
    fn color_hex_starts_with_hash() {
        for level in [GrayRotLevel::Healthy, GrayRotLevel::Warning,
                      GrayRotLevel::GrayRot, GrayRotLevel::Critical] {
