// ============================================================================
// Elu Tribe HotIndex — the hot resolution projection of the NUZI registry.
...
// exactly this reason. Renamed again, Anu -> Elu, 2026-08-15, when the
// Architect reclaimed "Anu" for the AnuGovernor (formerly Shakkanakku)
// rename (see docs/05_storage/ELU_INDEX_STACK.md).
//
