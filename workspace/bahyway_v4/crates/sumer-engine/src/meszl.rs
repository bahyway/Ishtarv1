...
pub const PHASE1_SIGNS: [MesZLSign; 15] = [
    ...
    MesZLSign { meszl: 532, glyph: '𒈨', name: "ME",    phonetic_primary: "me",    dimension: Some(HeptaDimension::ME)  },
    MesZLSign { meszl: 559, glyph: '𒄖', name: "GU",    phonetic_primary: "gu",    dimension: Some(HeptaDimension::GU)  },
    MesZLSign { meszl: 184, glyph: '𒊕', name: "SAG",   phonetic_primary: "sag",   dimension: Some(HeptaDimension::SAG) },
    MesZLSign { meszl: 839, glyph: '𒀀', name: "A",     phonetic_primary: "a",     dimension: Some(HeptaDimension::A)   },
    MesZLSign { meszl: 172, glyph: '𒉈', name: "IZI",   phonetic_primary: "izi",   dimension: Some(HeptaDimension::IZI) },
    MesZLSign { meszl: 596, glyph: '𒌓', name: "UD",    phonetic_primary: "ud",    dimension: Some(HeptaDimension::UD)  },
    MesZLSign { meszl: 71,  glyph: '𒌷', name: "URU",   phonetic_primary: "uru",   dimension: Some(HeptaDimension::URU) },
    // ── The eight core signs ─────────────────────────────────
    MesZLSign { meszl: 10,  glyph: '𒀭', name: "AN",    phonetic_primary: "an",    dimension: None },
    MesZLSign { meszl: 242, glyph: '𒁾', name: "DUB",   phonetic_primary: "dub",   dimension: None },
    MesZLSign { meszl: 541, glyph: '𒊬', name: "SAR",   phonetic_primary: "sar",   dimension: None },
    MesZLSign { meszl: 164, glyph: '𒂗', name: "EN",    phonetic_primary: "en",    dimension: None },
    MesZLSign { meszl: 737, glyph: '𒆠', name: "KI",    phonetic_primary: "ki",    dimension: None },
    MesZLSign { meszl: 266, glyph: '𒈗', name: "LUGAL", phonetic_primary: "lugal", dimension: None },
    MesZLSign { meszl: 495, glyph: '𒂍', name: "E2",    phonetic_primary: "e",     dimension: None },
    MesZLSign { meszl: 143, glyph: '𒉣', name: "NUN",   phonetic_primary: "nun",   dimension: None },
];
...
mod tests {
    ...
    fn seven_dimensional_signs_cover_all_dimensions_in_order() {
        let dims: Vec<HeptaDimension> =
            dimensional_signs().iter().filter_map(|s| s.dimension).collect();
    ...
    fn seeds_are_unique_and_position_sensitive() {
        let mut seeds: Vec<u64> =
            PHASE1_SIGNS.iter().map(|s| s.seed(0)).collect();
        seeds.sort_unstable();
        seeds.dedup();
