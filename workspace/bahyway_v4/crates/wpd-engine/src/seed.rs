...
pub fn sovereign_segments() -> Vec<PipelineSegment> {
    vec![
        ...
        PipelineSegment {
            ...
            lat_start:      33.3128, lon_start: 44.3614,
            lat_end:        33.3250, lon_end:   44.3800,
            diameter_mm:    400,
            length_m:       1_800.0,
        ...
        PipelineSegment {
            ...
            pipeline_type:  PipelineType::Water,
            lat_start:      33.3780, lon_start: 44.3381,
            lat_end:        33.3950, lon_end:   44.3550,
            diameter_mm:    300,
            length_m:       2_200.0,
        ...
        PipelineSegment {
            ...
            pipeline_type:  PipelineType::Water,
            lat_start:      33.3614, lon_start: 44.4478,
            lat_end:        33.3780, lon_end:   44.4650,
            diameter_mm:    250,
            length_m:       3_100.0,
        ...
        PipelineSegment {
            ...
            pipeline_type:  PipelineType::Water,
            lat_start:      33.3017, lon_start: 44.3953,
            lat_end:        33.3175, lon_end:   44.4120,
            diameter_mm:    350,
            length_m:       1_500.0,
            material:       PipeMaterial::DuctileIron,
            year_installed: 1995,
        ...
        PipelineSegment {
            ...
            pipeline_type:  PipelineType::Water,
            lat_start:      33.2817, lon_start: 44.3978,
            lat_end:        33.2980, lon_end:   44.4150,
            diameter_mm:    500,
            length_m:       2_800.0,
            material:       PipeMaterial::CastIron,
            year_installed: 1972,
        ...
        PipelineSegment {
            ...
            pipeline_type:  PipelineType::Water,
            lat_start:      33.2953, lon_start: 44.3614,
            lat_end:        33.3100, lon_end:   44.3780,
            diameter_mm:    300,
            length_m:       1_200.0,
        ...
        PipelineSegment {
            ...
            pipeline_type:  PipelineType::Water,
            lat_start:      33.3300, lon_start: 44.3150,
            lat_end:        33.3450, lon_end:   44.3320,
            diameter_mm:    350,
            length_m:       2_000.0,
            material:       PipeMaterial::DuctileIron,
            year_installed: 2001,
...
mod tests {
    ...
    fn all_seven_sectors_represented() {
        ...
        for sector in BaghdadSector::ALL {
            assert!(
                ...
                "sector {:?} missing from seed", sector
            );
        }
    }
    ...
    fn green_zone_is_lowest_defect_score() {
        let segs = sovereign_segments();
        let gz = segs.iter().find(|s| s.sector == BaghdadSector::GreenZone).unwrap();
        for other in &segs {
            if other.sector != BaghdadSector::GreenZone
                && other.sector != BaghdadSector::AlJadria
            {
                assert!(gz.defect_score <= other.defect_score,
                    "GreenZone score {} should be <= {} ({})", gz.defect_score, other.defect_score, other.id);
            }
        }
    }
}
