...
impl ZoneId {
    ...
    pub fn tribe(&self) -> BodyTribe {
        match self {
            ...
            ZoneId::Chest | ZoneId::Abdomen | ZoneId::LShoulderZ | ZoneId::RShoulderZ => {
                BodyTribe::Torso
            }
            ZoneId::LUpperArm | ZoneId::RUpperArm | ZoneId::LForearm | ZoneId::RForearm => {
                BodyTribe::Arms
            }
            ZoneId::LHip
            | ZoneId::RHip
    ...
    pub fn baseline_woman(&self) -> f32 {
        self.baseline_man() + 0.2
    }
