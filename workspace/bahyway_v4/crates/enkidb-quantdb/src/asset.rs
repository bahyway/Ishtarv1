...
impl AssetDescriptor {
    pub fn new(
        ...
        Self { asset_hash, ticker, name, asset_class, market, price_scale, currency_id }
    }
...
mod tests {
    ...
    fn asset_class_labels_non_empty() {
        for cls in [AssetClass::Equity, AssetClass::FixedIncome, AssetClass::Fx,
                    AssetClass::Commodity, AssetClass::Crypto, AssetClass::Reit,
                    AssetClass::Index] {
    ...
    fn to_real_price_correct() {
        let asset = AssetDescriptor::new(0x1234, "AAPL", "Apple Inc.", AssetClass::Equity,
            MarketId::NASDAQ, 100, 840);
