...
/* ═══ NASARU DEFAULT VISUALIZING STYLE — the shared interaction core ═══
   GL-VIZ-009. The single canonical implementation of the four interactions
  ...
  function create(opts){
    ...
    function renderStory(p){
      ...
      storyEl.innerHTML =
        ...
        '<div class="ns-innoc">this Particle is an individual — non-substitutable (GL-ONT-003)</div>';
    }
